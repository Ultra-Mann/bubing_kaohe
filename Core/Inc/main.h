...
extern  const fp32 PID_Speed_3508[3];  //3508速度环PID参数
extern  const fp32 PID_Speed[3];  //速度环PID参数
...
//extern fp32 Angle_Current;    //6020电机转换角度(返回ecd范围为0-8191  需转换为0-360 1度为o=fp32(8191/360))
